...
function show_average_salary(ndx) {
    ...
    dc.barChart("#average-salary")
        ...
        .valueAccessor(function(d){
            return d.value.average.toFixed(2); //or round to int
        })
        .transitionDuration(500)
        .x(d3.scale.ordinal())
        .xUnits(dc.units.ordinal)
...
function show_service_to_salary_correlation(ndx) {
    ...
    var yrsDim = ndx.dimension(dc.pluck("yrs_service"));
    var experienceDim = ndx.dimension(function(d) {
       return [d.yrs_service, d.salary, d.rank, d.sex];
    });
    var experienceSalaryGroup = experienceDim.group();
    
    var minExperience = yrsDim.bottom(1)[0].yrs_service;
    var maxExperience = yrsDim.top(1)[0].yrs_service;
